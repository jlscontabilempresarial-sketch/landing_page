...
export default function Navbar() {
  ...
  useEffect(() => {
    const sections = ["sobre", "servicos", "migracao", "mei-migracao", "feedback", "contatos"];
          ...
          for (let i = sections.length - 1; i >= 0; i--) {
            ...
            if (el) {
              ...
              if (scrollCenter >= offsetTop && scrollCenter <= offsetTop + height) {
                currentSection = (id === "migracao" || id === "mei-migracao") ? "servicos" : id;
                break;
              }
            }
          }
  ...
  const services = [
    ...
    { label: "Desenquadramento MEI", href: "/desenquadramento-mei" },
