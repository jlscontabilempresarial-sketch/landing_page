export const getWhatsAppLink = (path: string = "/", real: boolean = false) => {
  ...
  const messages: Record<string, string> = {
    ...
    "/desenquadramento-mei": "Olá! Meu MEI cresceu e preciso de ajuda para o desenquadramento e migração para ME."
  };
